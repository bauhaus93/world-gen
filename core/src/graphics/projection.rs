...
const ASPECT_RATIO: f32 = 3440. / 1440.;
...
pub fn create_orthographic_projection_matrix(
    ...
    let trans_input = Matrix4::<f32>::new(
        Vector4::<f32>::new(1., 0., 0., 0.),
        Vector4::<f32>::new(0., 1., 0., 0.),
        Vector4::<f32>::new(0., 0., -1., 0.),
        Vector4::<f32>::new(0., 0., 0., 1.),
    );
    create_scale_matrix(Point3f::new(
        2. / (right - left),
        2. / (top - bottom),
        2. / (far - near),
    )) * glm::ext::translate(
