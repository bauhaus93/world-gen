...
impl Cell {
    ...
    pub fn set_normal(&mut self, new_normal: Vector3<f64>) {
        debug_assert!(!new_normal.x.is_nan());
        debug_assert!(!new_normal.y.is_nan());
        debug_assert!(!new_normal.z.is_nan());
    ...
    pub fn calculate_flow(&self, dir: Direction, neighbour: &Cell, params: &Parameter) -> f64 {
        ...
        debug_assert!(!flow_delta.is_nan());
